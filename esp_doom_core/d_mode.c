...
doom_boolean D_ValidGameMode(GameMission_t mission, GameMode_t mode)
{
    int i;
...
doom_boolean D_ValidEpisodeMap(GameMission_t mission, GameMode_t mode,
                          int episode, int map)
{
    int i;
...
doom_boolean D_ValidGameVersion(GameMission_t mission, GameVersion_t version)
{
    int i;
...
doom_boolean D_IsEpisodeMap(GameMission_t mission)
{
    switch (mission)
    {
        case doom:
