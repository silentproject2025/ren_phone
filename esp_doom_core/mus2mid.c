...
static doom_boolean WriteTime(unsigned int time, MEMFILE *midioutput)
{
...
static doom_boolean WriteEndTrack(MEMFILE *midioutput)
{
...
static doom_boolean WritePressKey(byte channel, byte key,
...
static doom_boolean WriteReleaseKey(byte channel, byte key,
                               MEMFILE *midioutput)
{
...
static doom_boolean WritePitchWheel(byte channel, short wheel,
                               MEMFILE *midioutput)
{
...
static doom_boolean WriteChangePatch(byte channel, byte patch,
                                MEMFILE *midioutput)
{
...
static doom_boolean WriteChangeController_Valued(byte channel,
                                            byte control,
                                            byte value,
                                            MEMFILE *midioutput)
{
...
static doom_boolean WriteChangeController_Valueless(byte channel,
                                               byte control,
                                               MEMFILE *midioutput)
{
...
static doom_boolean ReadMusHeader(MEMFILE *file, musheader *header)
{
    doom_boolean result;
...
doom_boolean mus2mid(MEMFILE *musinput, MEMFILE *midioutput)
{
