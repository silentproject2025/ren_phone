...
typedef struct
{
    ...
    doom_boolean (*Init)(doom_boolean use_sfx_prefix);
    ...
    doom_boolean (*SoundIsPlaying)(int channel);
...
void I_InitSound(doom_boolean use_sfx_prefix);
...
doom_boolean I_SoundIsPlaying(int channel);
...
typedef struct
{
    ...
    void (*PlaySong)(void *handle, doom_boolean looping);
    ...
    doom_boolean (*MusicIsPlaying)(void);
...
void I_PlaySong(void *handle, doom_boolean looping);
void I_StopSong(void);
doom_boolean I_MusicIsPlaying(void);
