...
doom_boolean         storedemo;

// "BFG Edition" version of doom2.wad does not include TITLEPIC.
doom_boolean         bfgedition;

// If true, the main game loop has started.
doom_boolean         main_loop_started = false;
...
void D_Display (void)
{
    ...
    DG_PaletteLoad(W_CacheLumpName(DEH_String("PLAYPAL"), PU_STATIC));
...
doom_boolean D_GrabMouseCallback(void)
{
...
{
    doom_boolean is_freedoom = W_CheckNumForName("FREEDOOM") >= 0,
...
static doom_boolean D_AddFile(char *filename)
{
    wad_file_t *handle;
