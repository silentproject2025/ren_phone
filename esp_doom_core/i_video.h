...
typedef struct
{
    ...
    doom_boolean (*DrawScreen)(int x1, int y1, int x2, int y2);
    ...
    doom_boolean poor_quality;
} screen_mode_t;

typedef doom_boolean (*grabmouse_callback_t)(void);
...
void I_DisplayFPSDots(doom_boolean dots_on);
...
extern doom_boolean screenvisible;

extern float mouse_acceleration;
extern int mouse_threshold;
extern int vanilla_keyboard_mapping;
extern doom_boolean screensaver_mode;
extern int usegamma;
...
extern doom_boolean palette_changed;
