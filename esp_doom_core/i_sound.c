...
static doom_boolean SndDeviceInList(snddevice_t device, snddevice_t *list,
                               int len)
{
    int i;
...
static void InitSfxModule(doom_boolean use_sfx_prefix)
{
    int i;
...
{  
    doom_boolean nosound, nosfx, nomusic;
