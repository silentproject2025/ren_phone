...
typedef struct
{
    ...
    doom_boolean ingame[NET_MAXPLAYERS];
} ticcmd_set_t;
...
static doom_boolean  new_sync = true;
...
static doom_boolean local_playeringame[NET_MAXPLAYERS];
...
static doom_boolean BuildNewTic(void)
{
    int	gameticdiv;
    ticcmd_t cmd;
...
void D_ReceiveTic(ticcmd_t *ticcmds, doom_boolean *players_mask)
{
    int i;
...
static doom_boolean PlayersInGame(void)
{
    doom_boolean result = false;
    unsigned int i;
