...
doom_boolean NET_ReadInt8(net_packet_t *packet, unsigned int *data);
doom_boolean NET_ReadInt16(net_packet_t *packet, unsigned int *data);
doom_boolean NET_ReadInt32(net_packet_t *packet, unsigned int *data);

doom_boolean NET_ReadSInt8(net_packet_t *packet, signed int *data);
doom_boolean NET_ReadSInt16(net_packet_t *packet, signed int *data);
doom_boolean NET_ReadSInt32(net_packet_t *packet, signed int *data);
