...
void drawLockScreen(LGFX_Sprite& s){
  ...
  s.setCursor(tx, ty);
  s.print(tb);
  s.setFont(uiFontList[uiFontIdx]); // v66: balikin ke font PILIHAN USER (dulu hardcode Font0) -- dipakai semua teks lain di app ini
...
void drawSettings(LGFX_Sprite& s){
  ...
  s.setFont(uiFontList[uiFontIdx]);
...
void renderCurrentFrame(){
  canvas.setFont(uiFontList[uiFontIdx]); // v66: pasang font pilihan user SEBELUM layar apapun digambar
  if(locked){
