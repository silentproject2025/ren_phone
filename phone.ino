...
// v22: struct SearchBarState didefinisikan di SINI (dekat struct Theme,
// jauh di awal file) -- BUKAN di dekat kode WIDGET: TOMBOL CARI yg
// memakainya (lihat section itu di bawah, sebelum APP: ASTRONOMI) --
// supaya prototype otomatis yg dibikinkan Arduino/arduino-cli utk
// fungsi2 spt drawSearchBar()/searchBarHit() (yg menerima "SearchBarState&"
// sbg parameter) TETAP VALID biarpun prototype2 itu disisipkan di dekat
// awal file (sebelum definisi fungsi aslinya) -- kalau structnya baru
// dikenal jauh di tengah file, prototype yg disisipkan lebih awal bakal
// gagal compile krn tipe "SearchBarState" belum ada.
...
struct VibStep{ uint8_t on; uint16_t ms; }; // satu tahap: nyala(1)/mati(0) & berapa lama (ms)
